...
#include <Windows.h>
#include <thread>
bool      m_show, m_key_waiting;
uint32_t* m_current_key;

int8_t g_prev_key_states[256] = { 0 };
...
{
    for (int i = 0; i < 256; i++) {
        auto key_state = GetKeyState(i);
        g_prev_key_states[i] =
            (!g_prev_key_states[i] && key_state < 0) ? 8 : key_state < 0;
    }
}

bool is_key_down(short vk) { return g_prev_key_states[vk]; }

bool was_key_pressed(short vk) { return g_prev_key_states[vk] & 8; }

bool assign_next_key_pressed(short* vk)
{
    for (int i = 0; i < 256; i++)
        if (was_key_pressed(i)) {
            *vk = i;
            return true;
        }
    return false;
...
void ImGui::key_button(const char* name, unsigned int* key)
{
    if (key == nullptr)
        return;
    ...
    bool  this_is_waiting = m_key_waiting && key == m_current_key;
    const char* key_name;
    get_keycode_name(*key, key_name);

    ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 1.f, 1.f, 0.9f));
    if (ImGui::Button("Set")) {
        m_key_waiting = true;
        m_current_key = key;
    }
    ImGui::PopStyleColor();
    ImGui::SameLine();
    ImGui::Text("%s: %s", name, this_is_waiting ? "?" : key_name);
    ImGui::PopStyleColor();

    short vk;
    if (m_key_waiting && assign_next_key_pressed(&vk)) {
        *m_current_key = vk;
        m_key_waiting = false;
    }
...
#define get_keycode_name(vk, name)\
switch (vk) {\
case VK_CONTROL: name = xorStr("control"); break;\
case VK_SHIFT: name = xorStr("shift"); break;\
case VK_LSHIFT: name = xorStr("shift"); break;\
case VK_MENU: name = xorStr("alt"); break;\
case VK_TAB: name = xorStr("tab"); break;\
case VK_LBUTTON: name = xorStr("Mouse 1"); break;\
case VK_RBUTTON: name = xorStr("Mouse 2"); break;\
case VK_MBUTTON: name = xorStr("Mouse 3"); break;\
case VK_XBUTTON1: name = xorStr("Mouse 4"); break;\
case VK_XBUTTON2: name = xorStr("Mouse 5"); break;\
case VK_PRIOR: name = xorStr("page up"); break;\
case VK_NEXT: name = xorStr("page down"); break;\
case VK_END: name = xorStr("end"); break;\
case VK_HOME: name = xorStr("home"); break;\
case VK_LEFT: name = xorStr("left arrow"); break;\
case VK_UP: name = xorStr("up arrow"); break;\
case VK_RIGHT: name = xorStr("right arrow"); break;\
case VK_DOWN: name = xorStr("down arrow"); break;\
case VK_INSERT: name = xorStr("insert"); break;\
case VK_DELETE: name = xorStr("delete"); break;\
case 'A': name = xorStr("a"); break;\
case 'B': name = xorStr("b"); break;\
case 'C': name = xorStr("c"); break;\
case 'D': name = xorStr("d"); break;\
case 'E': name = xorStr("e"); break;\
case 'F': name = xorStr("f"); break;\
case 'G': name = xorStr("g"); break;\
case 'H': name = xorStr("h"); break;\
case 'I': name = xorStr("i"); break;\
case 'J': name = xorStr("j"); break;\
case 'K': name = xorStr("k"); break;\
case 'L': name = xorStr("l"); break;\
case 'M': name = xorStr("m"); break;\
case 'N': name = xorStr("n"); break;\
case 'O': name = xorStr("o"); break;\
case 'P': name = xorStr("p"); break;\
case 'Q': name = xorStr("q"); break;\
case 'R': name = xorStr("r"); break;\
case 'S': name = xorStr("s"); break;\
case 'T': name = xorStr("t"); break;\
case 'U': name = xorStr("u"); break;\
case 'V': name = xorStr("v"); break;\
case 'W': name = xorStr("w"); break;\
case 'X': name = xorStr("x"); break;\
case 'Y': name = xorStr("y"); break;\
case 'Z': name = xorStr("z"); break;\
case VK_NUMPAD0: name = xorStr("numpad 0"); break;\
case VK_NUMPAD1: name = xorStr("numpad 1"); break;\
case VK_NUMPAD2: name = xorStr("numpad 2"); break;\
case VK_NUMPAD3: name = xorStr("numpad 3"); break;\
case VK_NUMPAD4: name = xorStr("numpad 4"); break;\
case VK_NUMPAD5: name = xorStr("numpad 5"); break;\
case VK_NUMPAD6: name = xorStr("numpad 6"); break;\
case VK_NUMPAD7: name = xorStr("numpad 7"); break;\
case VK_NUMPAD8: name = xorStr("numpad 8"); break;\
case VK_NUMPAD9: name = xorStr("numpad 9"); break;\
case VK_F1: name = xorStr("F1"); break;\
case VK_F2: name = xorStr("F2"); break;\
case VK_F3: name = xorStr("F3"); break;\
case VK_F4: name = xorStr("F4"); break;\
case VK_F5: name = xorStr("F5"); break;\
case VK_F6: name = xorStr("F6"); break;\
case VK_F7: name = xorStr("F7"); break;\
case VK_F8: name = xorStr("F8"); break;\
case VK_F9: name = xorStr("F9"); break;\
case VK_F10: name = xorStr("F10"); break;\
case VK_F11: name = xorStr("F11"); break;\
case VK_F12: name = xorStr("F12"); break;\
default: name = xorStr("unknown");\
}
